...
Localhost addresses are excluded from automatic bans. There is no general CIDR allowlist in the application middleware. See [23 IP Security](23-ip-security.md).
